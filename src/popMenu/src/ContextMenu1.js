...
import { OPEN_ANIM_DURATION, CLOSE_ANIM_DURATION } from 'react-native-popup-menu/src/constants';
...
export default class ContextMenu1 extends React.Component {
...
// public exports
ContextMenu1.computePosition = computePosition;
...
export const styles = StyleSheet.create({
    options: {
        ...
        // This will elevate the holder on Android, causing shadow to be drawn.
        elevation: 5,
    },
});
