...
class Search extends PureComponent {
    ...
    render() {
        const styles = getStyles(this.props.inputHeight, this);
        return (
            <Animated.View
                ref="searchContainer"
                style={[
                    ...
                    {borderRadius: this.props.viewBorderRadius}
                ]}
            ...
            >
                ...
                <AnimatedTouchableOpacity onPress={this.onCancel} style={{
                    width: 50, height: 50,
...
const getStyles = (inputHeight, self) => {
    let middleHeight = 20
    ...
    return {
        container: {
            ...
            height: self.props.containerHeight,
            flexDirection: 'row',
        ...
        input: {
            height: self.props.containerHeight - 10,
            paddingTop: 5,
            paddingBottom: 5,
            paddingRight: 20,
            borderColor: '#444',
...
Search.propTypes = {
    ...
    viewBorderRadius: PropTypes.number,
