...
export default class OptionImprovePage extends Component {

    static propTypes = {
        ChangedImproveSort: PropTypes.func,
        improveSort: PropTypes.bool,
        popDialog: PropTypes.any,
        classId: PropTypes.string,
        type: PropTypes.number,
        getImproveData: PropTypes.func,
    };
    static defaultProps = {
        // improveData: [],
    };
    ...
    getOptions() {
        //查询
        this.sqLite.select(this.teacherId, this.props.classId, 1, this.props.entryType, {
    ...
    onSqLiteSuccess(data) {
        let improveData = data;
        this.state.data = improveData;
        this.getShowData();
        this.setState({
            isRefreshing: false,
            isNoData: false,
    ...
    getShowData() {
        let improveData = this.state.data;
        let showOwnData = [];
        for (let obj of improveData) {
        ...
        if (this.state.isShowOwn) {
            ...
            console.log('showOwnData777777777', showOwnData);
            ...
            this.state.showData = showData;
            this.state.sortData = improveData;
        }
        this.props.getImproveData(showOwnData);
    }
                ...
                >
                    <View style={{
                        ...
                        <View style={{alignItems: 'center'}}>
                            ...
                            <Text style={{color: colors.text999, fontSize: 13}}>暂无待改进事项</Text>
                            <KBButton onPress={() => {
    ...
    renderData() {
        let data = this.props.improveSort ? this.state.sortData : this.state.showData;
        ...
        return (
            <View style={{
                ...
                {
                    this.props.improveSort ?
                        <KBButton onPress={() => this.saveSort()}>
                            <View style={{
                                height: 49,
                                width: theme.screenWidth,
                                backgroundColor: colors.yellowColor,
    ...
    longPress() {
        ...
        this.props.ChangedImproveSort(true);
        this.props.getImproveData(this.state.sortData);
        this.setState({});
    }
     ...
     */
    saveSort() {
        console.log('排序000000', this.itemOrderData);
         ...
         */
        this.sqLite.deleteSortData(this.teacherId, this.props.classId, this.props.entryType, 1);
        ...
        this.sqLite.insertSortData(sortData, () => {
            this.props.ChangedImproveSort(false);
            // this.refreshData();
            // this.optionRefresh();
        });
    }
