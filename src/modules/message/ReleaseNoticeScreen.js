...
import {Image, StyleSheet, Text, View, Keyboard, DeviceEventEmitter, TextInput} from 'react-native';
...
export default class ReleaseNoticeScreen extends Component {
    ...
    render() {
        return (
            <Container style={this.styles.container}>
                ...
                <View>
                    <View
                        style={{width: theme.screenWidth, backgroundColor: colors.white}}>
                        ...
                        <View
                            ...
                            <TextInputWithClear
                                ...
                                multiline={true}
                                placeholderText={'输入班级公告内容（最多500字）'}
    ...
    createNotice = () => {
        if (Utils.isNull(this.state.content) || this.state.content.length === 0) {
            ToastUtils.showToast('请输入班级公告内容');
            return;
        }
        ...
        HttpUtils.doPostWithToken(fetchUrl.createNotice, formData, {
            onSuccess: (responseData) => {
                ToastUtils.showToast('班级公告发布成功！');
