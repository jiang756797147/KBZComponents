...
var SDB = {
    "a": {
        ...
        "jin": "!#$j$k%M)8)G.U.m/J4W4`6L70:/B6F&FGcGkJYM!TWW%WzX<X@]9_sb&bIc#j2j<k8olomp>sTwGy2-!^-'m-(Y-)$-7D-88-::",
...
export default class PinYinUtils {
    ...
    static getSpell(chars, polyphone, spliter) {
        var cToS = DB.cToS;
        var res = [],
        ...
        return this.getAllPinYin(res);
    }

    static getAllPinYin(res) {
        let pinyin;
        for (let model of res) {
            // console.log("3212442141", Object.prototype.toString.call(model));

            if (Object.prototype.toString.call(model) === '[object Array]') {
                pinyin = (Utils.isNull(pinyin) ? "" : pinyin) + this.getAllPinYin(model);
            } else {
                pinyin = (Utils.isNull(pinyin) ? "" : pinyin) + model
            }
        }
        return pinyin;
    }

    static getChars(spell) {
        var sToC = DB.sToC;
