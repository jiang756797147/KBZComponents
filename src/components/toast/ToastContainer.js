...
class ToastContainer extends Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps: Readonly<P>, nextContext: any): void {
        console.log('next =================', nextProps.visible);
        console.log('this =================', this.props.visible);
    ...
    _press = async() => {
        await this.props.press && this.props.press(this.props.siblingManager);
    ...
    render() {
        ...
        >
            <TouchableWithoutFeedback
                onPress={this.props.hideOnPress ? this._press : null}
            >
                <Animated.View
                    style={[
                ...
                >
                    {this.props.hasIcon ?
                        <Image style={{width: 16, height: 16, marginRight: 5}}
                               source={require('../../assets/chehui.png')}
                        /> : null
                    }
                    <Text style={[
                        styles.textStyle,
